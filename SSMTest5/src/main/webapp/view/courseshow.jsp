...
<body>
	...
	<form action="http://localhost:8080/Voids/Course/deleteall.do">
		...
		<c:forEach items="${list}" var="list">
					<tr>
						...
						<td><a href="updateCourse?id=${list.id}">✎</a></td>
	...
	function pre() {
		  if (${page-1}==0) {				  
			  alert("已经是首页");
				location.href="selectAllCourse?page=${page}"; 
		}else {				
			location.href="selectAllCourse?page=${page-1}";
		} 
	}
	 function next(c) {
		  if (${page+1}>c) {
